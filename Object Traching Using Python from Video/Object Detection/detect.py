# python detect.py --prototext deploy.prototxt.txt --model deploy.caffemodel
# import packages
# python detect.py -p deploy.prototxt.txt -m deploy.caffemodel
...
CLASSES = ["aeroplane", "background", "bicyclqe", "bird", "boat",
...
# The model from Caffe: deploy.prototxt.txt; deploy.caffemodel;
